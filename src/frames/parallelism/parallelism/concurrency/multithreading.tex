  ...
  \on[y=-4.5mm]{
    \begin{tikzpicture}
      \begin{scope}
        ...
        \node[anchor=south east, inner sep=0pt, outer sep=0pt] (parall) at (0,-2mm) {\includegraphics[width=\paperwidth/2]{pupies_theory}};
        \node[anchor=south west, inner sep=0pt, outer sep=0pt] (concur) at (0,-2mm) {\includegraphics[width=\paperwidth/2]{pupies_practice}};
