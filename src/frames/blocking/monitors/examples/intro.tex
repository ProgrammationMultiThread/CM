...
\begin{frame}{Moniteur}
  ...
  \onImage[x=-20mm, y=-8mm]{%
    ...
    license={\textcopyright{} Per Brinch Hansen (1999)  -- usage autorisé avec attribution (\href{https://commons.wikimedia.org/wiki/File:Per_Brinch_Hansen_-_1999.jpg}{Wikimedia})},
    img={Hansen.jpg}
  }
  ...
  \onImage[x=20mm, y=-8mm]{%
    height=3.2cm,
    title={Tony Hoare},
    license={\ccbysa{} {CC-BY-SA-2.0-FR} -- Rama 2011 (\href{https://commons.wikimedia.org/wiki/File:Sir_Tony_Hoare_IMG_5125.jpg}{Wikimedia})},
    img={Hoare.jpg}
  }
