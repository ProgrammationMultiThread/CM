...
\begin{frame}[fragile]{Que fait ce programme ?}
  ...
  \footnoteref{Exemple inspiré du tutoriel Java d'Oracle (\href{https://docs.oracle.com/javase/tutorial/essential/concurrency/deadlock.html}{Java Documentation})}
  \footnoterefgithub{liveness}{Friends}
